...
const destinationCardVariants = cva(
  "relative group border-0 shadow-sm overflow-hidden",
  {
    variants: {
      aspectRatio: {
...
interface DestinationCardProps {
  ...
  aspectRatio?: "aspect-4/3" | "aspect-square" | "aspect-video" | "default";
}
...
export default function DestinationCard({
  ...
  return (
    <Link href={href} className={cn("block", className)}>
      <Card className={destinationCardVariants({ aspectRatio })}>
        <ImageWithFallback
          src={image || ""}
          alt={title}
          fill
