...
import { serverImageService } from '@/services/server-image.service';
...
export async function getOrFetchCityImage(
  ...
  if (result.imageUrl) {
    console.log(`💾 Would save image for city ${cityId}:`, result.imageUrl);
    // await prisma.city.update({
    //   where: { id: cityId },
    //   data: { imageHeroUrl: result.imageUrl }
    // });
  }
...
export async function getOrFetchPlaceImage(
  ...
  // TODO: Save to database for future use
  if (result.imageUrl) {
    console.log(`💾 Would save image for place ${placeId}:`, result.imageUrl);
...
export const FALLBACK_IMAGES = {
  ...
  beach: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop', // Beach
  mountain: 'https://images.unsplash.com/photo-1454391304352-2bf4678b1a7a?w=800&h=600&fit=crop', // Mountain
  landmark: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&h=600&fit=crop', // Landmark
  nature: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=600&fit=crop', // Nature
  default: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&h=600&fit=crop', // Travel
};
