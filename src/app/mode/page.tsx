...
export const Button = ({
  ...
  const base =
    "px-4 py-2 rounded-lg font-medium transition-all active:scale-95 disabled:opacity-50 cursor-pointer hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-brand/50 active:scale-95 disabled:bg-surface  disabled:cursor-not-allowed";
